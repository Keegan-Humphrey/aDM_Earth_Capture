...
SeriesBoundary = {100,100}; (*(u,z) boundary point where we switch to approximate formulae*)
\[Epsilon]RPAC[u_,z_,u\[Nu]_]:={1,0} + "\[Chi]"^2/(4 z^3) Piecewise[{{\[Epsilon]RPACnearzequ[u,z,u\[Nu]],Abs[u-z]<5&&(u>=SeriesBoundary[[1]]||z>=SeriesBoundary[[2]])},{{(4 z)/(3 (-u^2+z^2)),(8 u u\[Nu] z)/(3 (u-z)^2 (u+z)^2)},Abs[u-z]>5&&(u>=SeriesBoundary[[1]]||z>=SeriesBoundary[[2]])}},(\[CapitalZeta][u+z,u\[Nu]]-\[CapitalZeta][u-z,u\[Nu]])]
