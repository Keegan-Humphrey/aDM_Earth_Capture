...
class darkelf(object):
    ...
    def DM_params(self):
        ...
        # print("v0 = " + str(self.v0kms) + " kms")
        # print("vesc = " + str(self.vesckms) + " kms")
        return
    ...
    # we need to alter these for our disk case
    ...
    # vmin(omega, k) in units of c
    # def vmin(self,omega,k):
        # return omega/k + k/(2*self.mX) + self.delta/k if self.vdist == "halo" else max( omega/k + k/(2*self.mX),self.vescdisk)
    ...
    # we need to change these too for disk.
